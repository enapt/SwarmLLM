...
impl PipelineExecutor {
    ...
    // execute_tp_segment lives in tensor_parallel.rs — extracted to reduce
    // pipeline/mod.rs file size and isolate the AllReduce coordination code
    // from the per-token decode loop.
}
