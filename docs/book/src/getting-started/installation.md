...
| `ghcr.io/enapt/swarmllm:0.3.11-alpha` | Pinned version (CPU) |
| `ghcr.io/enapt/swarmllm:0.3.11-alpha-cuda` | Pinned version (GPU) |
...
```bash
cargo install --git https://github.com/enapt/SwarmLLM.git --tag v0.3.11-alpha
swarmllm run
```
