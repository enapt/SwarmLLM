...
Versioned tags follow semver — e.g. `0.3.13-alpha`, `0.3.13-alpha-cuda` (pre-releases publish the full version; stable releases additionally get the `0.3` / `0.3-cuda` minor tags).
