...
> **Status — alpha**, actively developed. Distributed inference is stable across multi-node deployments. 1124 lib tests + 75 integration tests run on every PR; continuous security sweeps. [Report issues](https://github.com/enapt/SwarmLLM/issues).
>
...
sudo dpkg -i swarmllm_0.3.10-alpha_amd64.deb            # Debian / Ubuntu
sudo rpm -i swarmllm_0.3.10-alpha.x86_64.rpm            # Fedora / RHEL
```
